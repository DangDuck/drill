...
<head>
    ...
    <title>Tribina Jasaindo - Login</title>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-sm-10 mx-auto">
                                <div class="row">
                                    <img src="assets/logo.jpg" class="img-fluid mx-auto mt-5">
                                </div>
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">CV. Tribina Jasaindo</h1>
                                    ...
                                    <form class="user" method="POST" action="home/auth">
                                        <?= csrf_field(); ?>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user <?= ($validation->hasError('username')) ? 'is-invalid' : '' ?>" id="username" name="username" placeholder="Enter Username...">
